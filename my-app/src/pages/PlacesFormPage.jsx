        ...
        <div>
            <AccountNav />
                    <form onSubmit={savePlace}>
                        ...
                        <input type="text" value={title} onChange={event=>setTitle(event.target.value)} placeholder="title, e.g. My lovely apartments" />
                        ...
                        {preInput('Check in&out time','Add check in & out times, remember to have some time window for cleaning the room between guests check in & out')}
